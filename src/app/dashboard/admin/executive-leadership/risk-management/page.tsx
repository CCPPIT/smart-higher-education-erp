...
import { Shield, AlertTriangle, CheckCircle, TrendingUp, FileText, Eye, Lock } from 'lucide-react';

const RiskManagementPage: React.FC = () => {
  const stats = [
    { title: 'المخاطر المحددة', value: '78', icon: AlertTriangle, trend: '+5%', color: 'text-red-600' },
    { title: 'خطط المعالجة', value: '67', icon: CheckCircle, trend: '+12%', color: 'text-green-600' },
    { title: 'المراجعات الدورية', value: '156', icon: Eye, trend: '+18%', color: 'text-blue-600' },
    { title: 'فعالية الإجراءات', value: '91%', icon: Shield, trend: '+8%', color: 'text-purple-600' }
  ];
